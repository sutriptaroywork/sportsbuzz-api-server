const prod = {
  ...
  FANTASY_NODE_URL: process.env.FANTASY_NODE_URL || 'https://apiv2.sportsbuzz11.com',
  FRONTEND_HOST_URL: process.env.FRONTEND_HOST_URL || 'https://game.sportsbuzz11.com',
  ...
  REDIS_3_HOST: process.env.REDIS_3_HOST || process.env.REDIS_2_HOST || 'localhost',
  REDIS_3_PORT: process.env.REDIS_3_PORT || process.env.REDIS_2_PORT || 6379,
  ...
  MAIL_TRANSPORTER: {
    ...
    auth: {
      user: process.env.SMTP_USERNAME || 'support@sportsbuzz11.com',
      pass: process.env.SMTP_PASSWORD || 'xhznfhglhnpmsitz'
    },
    secure: false
  },
  SMTP_FROM: process.env.SMTP_FROM || 'support@sportsbuzz11.com',
  ...
  FIREBASE_WEB_API_KEY: process.env.FIREBASE_WEB_API_KEY || 'AIzaSyCG44dOPMAwomsLZHqvGKMMpax37rbB8po',
  ...
  CASHFREE_URL: process.env.CASHFREE_URL || 'https://api.cashfree.com',
  CASHFREE_APPID: process.env.CASHFREE_APPID || '28733609988583301e14193008633782',
  CASHFREE_SECRETKEY: process.env.CASHFREE_SECRETKEY || 'c1f60dac9ead4c081b8c8fe030bf82f86828afa1',
  CASHFREE_RETURN_URL: process.env.CASHFREE_RETURN_URL || 'https://www.google.com/',
  // CASHFREE_RETURN_URL: 'https://game.sportsbuzz11.com/deposit',
  CASHFREE_STABLE_URL: process.env.CASHFREE_STABLE_URL || 'https://api.cashfree.com/pg',

  CASHFREE_BASEURL: process.env.CASHFREE_BASEURL || 'https://api.cashfree.com',
  CASHFREE_CLIENTID: process.env.CASHFREE_CLIENTID || '28733609988583301e14193008633782',
  CASHFREE_CLIENTSECRET: process.env.CASHFREE_CLIENTSECRET || 'c1f60dac9ead4c081b8c8fe030bf82f86828afa1',
  ...
  STABLE_CASHFREE_BASEURL: process.env.STABLE_CASHFREE_BASEURL || 'https://api.cashfree.com/pg',
...
-----END PUBLIC KEY-----`,
  ...
  GAME_DB_POOLSIZE: process.env.GAME_DB_POOLSIZE || 18,
  MATCH_DB_POOLSIZE: process.env.MATCH_DB_POOLSIZE || 11,
  FANTASY_TEAM_DB_POOLSIZE: process.env.FANTASY_TEAM_DB_POOLSIZE || 12,
  LEAGUES_DB_POOLSIZE: process.env.LEAGUES_DB_POOLSIZE || 8,
  ADMINS_DB_POOLSIZE: process.env.ADMINS_DB_POOLSIZE || 6,
  SERIES_LB_DB_POOLSIZE: process.env.SERIES_LB_DB_POOLSIZE || 6,
  USERS_DB_POOLSIZE: process.env.USERS_DB_POOLSIZE || 16,
  STATISTICS_DB_POOLSIZE: process.env.STATISTICS_DB_POOLSIZE || 8,
  BANNERS_DB_POOLSIZE: process.env.BANNERS_DB_POOLSIZE || 8,
  COMPLAINS_DB_POOLSIZE: process.env.COMPLAINS_DB_POOLSIZE || 5,
  FANTASYTIPS_DB_POOLSIZE: process.env.FANTASYTIPS_DB_POOLSIZE || 7,
  ...
  ROUTE_AUTH_TOKEN: process.env.ROUTE_AUTH_TOKEN || 'da39a3ee5e6b4b0d3255bfef95601890afd80709',

  TRANSACTION_LOG_BULK_INSERT_SIZE: Number(process.env.TRANSACTION_LOG_BULK_INSERT_SIZE) || 30,
  ...
  SB11_BACKEND_MS_USER_PROFILE_SERVICE: process.env.SB11_BACKEND_MS_USER_PROFILE_SERVICE,
  SB11_BACKEND_MS_LOG_SERVICE: process.env.SB11_BACKEND_MS_LOG_SERVICE,
  SB11_BACKEND_MS_LEAGUE_SERVICE: process.env.SB11_BACKEND_MS_LEAGUE_SERVICE,
  SB11_BACKEND_MS_PAYMENT_SERVICE: process.env.SB11_BACKEND_MS_PAYMENT_SERVICE,

  // Firebase Queue
  ADD_LEAGUE_QUEUE: process.env.ADD_LEAGUE_QUEUE,
  ADD_PRIZE_BREAKUP_QUEUE: process.env.ADD_PRIZE_BREAKUP_QUEUE,
  NOTIFICATION_SERVICE_BASE_URL: process.env.NOTIFICATION_SERVICE_BASE_URL,
  SB11_BACKEND_MS_COMPLAINT_SERVICE: process.env.SB11_BACKEND_MS_COMPLAINT_SERVICE
}
