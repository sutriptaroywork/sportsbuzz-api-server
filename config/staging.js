const staging = {
  ...
  FANTASY_NODE_URL: process.env.FANTASY_NODE_URL || 'https://apiv2.beta.sportsbuzz11.com',
  FRONTEND_HOST_URL: process.env.FRONTEND_HOST_URL || 'https://game.beta.sportsbuzz11.com',
  ...
  FIREBASE_SUBSCRIBE_USER_QUEUE: process.env.FIREBASE_SUBSCRIBE_USER_QUEUE,
  PUSH_TOKEN_NOTIFICATION_QUEUE: process.env.PUSH_TOKEN_NOTIFICATION_QUEUE,
  PUSH_TOPIC_NOTIFICATION_QUEUE: process.env.PUSH_TOPIC_NOTIFICATION_QUEUE,
  SEND_MULTICAST_NOTIFICATION_QUEUE: process.env.SEND_MULTICAST_NOTIFICATION_QUEUE
